  ...
  return (
    <div className="p-6 text-gray-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
        <div className="lg:col-span-2 p-4 bg-gray-800 rounded-lg shadow flex items-center justify-center">
        ...
        <div className="lg:col-span-3 space-y-4">
            <div className="p-4 bg-gray-800 rounded-lg shadow text-center h-full flex flex-col justify-around">
              <div>
                <h3 className="text-md font-medium text-gray-400">Total na Lista Atual</h3>
                <p className="text-2xl font-bold text-blue-500">{formatCurrency(totalVisible)}</p>
              </div>
              <div>
      ...
      <div className="space-y-4 mb-6 p-4 bg-gray-800 rounded-lg shadow">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto text-gray-300">
