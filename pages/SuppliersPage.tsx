...
const SupplierFormModal: React.FC<{ supplier: Supplier | null; onSave: (supplier: Supplier) => void; onClose: () => void; }> = ({ supplier, onSave, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4">
            <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-xl w-full max-w-lg text-gray-300">
...
const SupplierDetailsModal: React.FC<{ supplier: Supplier; debts: Debt[]; payments: SupplierCredit[]; onSave: (key: string, data: any) => void; onClose: () => void; }> = ({ supplier, debts, payments, onSave, onClose }) => {
    ...
    const pieChartData: ChartData<'pie'> = useMemo(() => {
        return {
            ...
            datasets: [{ data: [Math.max(0, supplierStats.balance), supplierStats.totalPaid], backgroundColor: ['#ef4444', '#22c55e'], borderColor: ['#1f2937', '#1f2937'], borderWidth: 2 }]
        }
    }, [supplierStats]);
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 z-[60] flex items-center justify-center p-4">
            <div className="bg-gray-800 p-4 md:p-6 rounded-lg shadow-2xl w-full max-w-6xl max-h-[95vh] text-gray-300 flex flex-col">
                ...
                <div className="flex-grow overflow-y-auto pr-4 -mr-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                        <div className="lg:col-span-2 bg-gray-900/50 p-4 rounded-lg space-y-2">
                        ...
                        <div className="bg-gray-900/50 p-4 rounded-lg h-64">{supplierStats.totalDebtAmount > 0 && <Pie ref={chartRef} data={pieChartData} options={pieOptions} />}</div>
                    </div>
