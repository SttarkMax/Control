    ...
    <div className="p-6 text-gray-300">
            ...
            <thead className="bg-gray-700">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                  <Input 
                    type="checkbox" 
                    className="form-checkbox h-4 w-4 text-yellow-500 bg-gray-600 border-gray-500 rounded focus:ring-yellow-400"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto text-gray-300">
